    <header class="header">
        <?php  require('./template/topo.php'); #Milestone 1 - Issue 2 ?>
    </header>
    <?php
        $banners = array(
        	array(
    ...
    <section class="vantagens">
        <?php require 'template/vantagens.php' #Milestone 1 - Issue 2 ?>
    </section>

    <section class="funcionalidades">
        <?php require 'template/funcionalidades.php' #Milestone 1 - Issue 2 ?>
    </section>
    ...
    <footer class="footer">
        <?php require 'template/rodape.php' #Milestone 1 - Issue 2 ?>
    </footer>
